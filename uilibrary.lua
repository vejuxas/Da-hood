        ...
        Components.Page = function(Data)
            ...
            function Page:Turn(Bool)
                ...
                if Page.Active then 
                    ...
                    Items["Page"].Instance.Size = UDim2New(1, 0, 0, 0)
                    
                    -- Animate page fade in and slide
                    Items["Page"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        Size = UDim2New(1, 0, 1, 0)
                    })
                    
                    -- Fade in page content
                    for _, descendant in pairs(Items["Page"].Instance:GetDescendants()) do
                        if descendant:IsA("UIStroke") then
                            descendant.Transparency = 1
                            TweenService:Create(descendant, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Transparency = 0}):Play()
                        elseif descendant:IsA("TextLabel") or descendant:IsA("TextButton") then
                            descendant.TextTransparency = 1
                            TweenService:Create(descendant, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
                        elseif descendant:IsA("ImageLabel") or descendant:IsA("ImageButton") then
                            descendant.ImageTransparency = 1
                            TweenService:Create(descendant, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageTransparency = 0}):Play()
                        elseif descendant:IsA("Frame") or descendant:IsA("ScrollingFrame") then
                            if descendant.BackgroundTransparency < 1 then
                                descendant.BackgroundTransparency = 1
                                TweenService:Create(descendant, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0}):Play()
                            end
                        end
                    end
                    ...
                    for _, descendant in pairs(Items["Page"].Instance:GetDescendants()) do
                        if descendant:IsA("UIStroke") then
                            TweenService:Create(descendant, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Transparency = 1}):Play()
                        elseif descendant:IsA("TextLabel") or descendant:IsA("TextButton") then
                            TweenService:Create(descendant, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextTransparency = 1}):Play()
                        elseif descendant:IsA("ImageLabel") or descendant:IsA("ImageButton") then
                            TweenService:Create(descendant, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageTransparency = 1}):Play()
                        elseif descendant:IsA("Frame") or descendant:IsA("ScrollingFrame") then
                            if descendant.BackgroundTransparency < 1 then
                                TweenService:Create(descendant, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundTransparency = 1}):Play()
                            end
                        end
                    end
                    
                    Items["Page"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
